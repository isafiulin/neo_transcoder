...
import '../features/profiles/profiles_cubit.dart';
import '../features/profiles/profiles_screen.dart';
import '../features/settings/settings_cubit.dart';
import '../features/settings/settings_screen.dart';
import '../features/splash/splash_screen.dart';
import '../features/streams/streams_cubit.dart';
...
GoRouter createRouter(SessionCubit session) {
  return GoRouter(
    ...
    redirect: (BuildContext context, GoRouterState state) {
      ...
      final String from = state.uri.queryParameters['from'] ?? AppRoutes.dashboard;
    ...
    routes: <RouteBase>[
      ...
      ShellRoute(
        builder: (BuildContext context, GoRouterState state, Widget child) => AppShell(
...
String _withFrom(String path, String from) {
  return Uri(path: path, queryParameters: <String, String>{'from': from}).toString();
}
